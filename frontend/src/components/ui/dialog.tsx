...
export function DialogViewport({
  ...
  return (
    <DialogPrimitive.Viewport
      className={cn(
        "fixed inset-0 z-50 grid grid-cols-[minmax(0,1fr)] grid-rows-[1fr_auto_3fr] justify-items-center p-4",
        className
      )}
...
export const DialogBody = DialogPanel
